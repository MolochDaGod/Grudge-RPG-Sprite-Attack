...
export const GRUDA_ROSTER: GrudaCharDef[] = [
  ...
  { id:"knight", name:"Knight", folder:"Knight", color:"#e74c3c", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"archer", name:"Archer", folder:"Archer", color:"#27ae60", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"wizard", name:"Wizard", folder:"Wizard", color:"#8e44ad", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"orc", name:"Orc", folder:"Orc", color:"#2ecc71", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"skeleton", name:"Armored Skeleton", folder:"Armored-Skeleton", color:"#95a5a6", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"swordsman", name:"Swordsman", folder:"Swordsman", color:"#e67e22", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"priest", name:"Priest", folder:"Priest", color:"#f1c40f", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"armored-orc", name:"Armored Orc", folder:"armored-orc", color:"#196f3d", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"elite-orc", name:"Elite Orc", folder:"elite-orc", color:"#1e8449", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
  ...
  { id:"knight-templar", name:"Knight Templar", folder:"knight-templar", color:"#f39c12", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
  ...
  { id:"barbarian-ranger", name:"Barbarian Ranger", folder:"barbarian-ranger", color:"#c0392b", frameSize:100, renderScale:2,
  ...
  { id:"elf-ranger", name:"Elf Ranger", folder:"elf-ranger", color:"#27ae60", frameSize:100, renderScale:2,
  ...
  { id:"werebear", name:"Werebear", folder:"werebear", color:"#6e2c00", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
    attack:["attack1.png",9], attack2:["attack2.png",13], special:["attack3.png",9],
    hurt:["hurt.png",4], death:["death.png",4],
    atk:16, spd:4.6, superDmg:42, superName:"Bear Maul" },
  { id:"werewolf", name:"Werewolf", folder:"werewolf", color:"#4a235a", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"barbarian-warrior", name:"Barbarian", folder:"barbarian-warrior", color:"#d35400", frameSize:100, renderScale:2,
  ...
  { id:"silver-knight", name:"Silver Knight", folder:"silver-knight", color:"#c0c0c0", frameSize:180,
  ...
  // ─── 80px frame heroes ─────────────────────────────────────────
  { id:"free-knight", name:"Dwarf Mage", folder:"free-knight", color:"#7d3c98", frameSize:96,
  ...
  { id:"wanderer-magician", name:"Wanderer Magician", folder:"wanderer-magician", color:"#8B4513", frameSize:128,
