...
export const GRUDA_ROSTER: GrudaCharDef[] = [
  ...
  { id:"knight", name:"Knight", folder:"Knight", color:"#e74c3c", frameSize:100, renderScale:2,
  ...
  { id:"archer", name:"Archer", folder:"Archer", color:"#27ae60", frameSize:100, renderScale:2,
  ...
  { id:"wizard", name:"Wizard", folder:"Wizard", color:"#8e44ad", frameSize:100, renderScale:2,
  ...
  { id:"orc", name:"Orc", folder:"Orc", color:"#2ecc71", frameSize:100, renderScale:2,
  ...
  { id:"skeleton", name:"Armored Skeleton", folder:"Armored-Skeleton", color:"#95a5a6", frameSize:100, renderScale:2,
  ...
  { id:"swordsman", name:"Swordsman", folder:"Swordsman", color:"#e67e22", frameSize:100, renderScale:2,
  ...
  { id:"priest", name:"Priest", folder:"Priest", color:"#f1c40f", frameSize:100, renderScale:2,
  ...
  { id:"armored-orc", name:"Armored Orc", folder:"armored-orc", color:"#196f3d", frameSize:100, renderScale:2,
  ...
  { id:"elite-orc", name:"Elite Orc", folder:"elite-orc", color:"#1e8449", frameSize:100, renderScale:2,
    idle:["idle.png",6], walk:["walk.png",8],
  ...
  { id:"knight-templar", name:"Knight Templar", folder:"knight-templar", color:"#f39c12", frameSize:100, renderScale:2,
    idle:["idle.png",6], walk:["walk.png",8],
  ...
  { id:"werebear", name:"Werebear", folder:"werebear", color:"#6e2c00", frameSize:100, renderScale:2,
    idle:["idle.png",6], walk:["walk.png",8],
    attack:["attack1.png",9], attack2:["attack2.png",13], special:["attack3.png",9],
    hurt:["hurt.png",4], death:["death.png",4],
    atk:16, spd:4.6, superDmg:42, superName:"Bear Maul" },
  { id:"werewolf", name:"Werewolf", folder:"werewolf", color:"#4a235a", frameSize:100, renderScale:2,
