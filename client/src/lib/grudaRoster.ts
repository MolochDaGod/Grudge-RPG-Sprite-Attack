...
// ─── Assist types (MvC-style) ───────────────────────────────────
export type AssistType = 'alpha' | 'beta' | 'gamma';
// alpha = melee rush, beta = projectile, gamma = anti-air/launcher

export interface AssistConfig {
  assistType: AssistType;
  assistAnimation: string; // which attack anim to play (e.g. "attack", "cast")
...
export interface GrudaCharDef {
  ...
  superDmg: number;
  superName: string;
  // Hustle-style sprites (128x128 frame sheets)
  hustleSprite?: boolean;
  // Assist config — only used when role='assist' or when selected as an assist
  assist?: AssistConfig;
}
...
// ─── Helper accessors ──────────────────────────────────────────
export function getMainRoster(): GrudaCharDef[] {
  return GRUDA_ROSTER.filter(c => c.role === 'main');
}
export function getAssistRoster(): GrudaCharDef[] {
  return GRUDA_ROSTER.filter(c => c.role === 'assist');
}
...
export const GRUDA_ROSTER: GrudaCharDef[] = [
  ...
  { id:"hustle-knight", name:"Knight", folder:"hustle-knight", color:"#e74c3c", faction:"crusade", role:"main", frameSize:128, hustleSprite:true,
    idle:["idle.png",6], walk:["walk.png",12], attack:["attack.png",5], attack2:["attack2.png",5],
    hurt:["hurt.png",4], death:["death.png",5], block:["block.png",1], jump:["jump.png",17],
    roll:["roll.png",8], special:["attack3.png",4],
    atk:14, spd:5.6, superDmg:38, superName:"Steel Tempest" },
  { id:"hustle-mage", name:"Mage", folder:"hustle-mage", color:"#8e44ad", faction:"fabled", role:"main", frameSize:128, hustleSprite:true,
    idle:["idle.png",6], walk:["walk.png",12], attack:["attack.png",5], attack2:["attack2.png",5],
    hurt:["hurt.png",4], death:["death.png",5], block:["block.png",1], jump:["jump.png",17],
    roll:["roll.png",8], special:["attack3.png",4], cast:["teleport.png",17],
    projectile:"projectile.png",
    atk:11, spd:5.4, superDmg:44, superName:"Arcane Oblivion" },
  { id:"hustle-berserker", name:"Berserker", folder:"hustle-berserker", color:"#d35400", faction:"legion", role:"main", frameSize:128, hustleSprite:true,
    idle:["idle.png",6], walk:["walk.png",12], attack:["attack.png",5], attack2:["attack2.png",5],
    hurt:["hurt.png",4], death:["death.png",5], block:["block.png",1], jump:["jump.png",17],
    roll:["roll.png",8], special:["attack3.png",4],
    atk:17, spd:4.8, superDmg:42, superName:"Berserker Fury" },
  { id:"hustle-rogue", name:"Rogue", folder:"hustle-rogue", color:"#2c3e50", faction:"legion", role:"main", frameSize:128, hustleSprite:true,
    idle:["idle.png",6], walk:["walk.png",12], attack:["attack.png",5], attack2:["attack2.png",5],
    hurt:["hurt.png",4], death:["death.png",5], block:["block.png",1], jump:["jump.png",17],
    roll:["roll.png",8], special:["attack3.png",4],
    atk:12, spd:7.4, superDmg:30, superName:"Shadow Dance" },
  { id:"hustle-archer", name:"Archer", folder:"hustle-archer", color:"#27ae60", faction:"crusade", role:"main", frameSize:128, hustleSprite:true,
    idle:["idle.png",6], walk:["walk.png",12], attack:["attack.png",5], attack2:["attack2.png",5],
    hurt:["hurt.png",4], death:["death.png",5], block:["block.png",1], jump:["jump.png",17],
    roll:["roll.png",8], special:["attack3.png",4],
    atk:10, spd:6.8, superDmg:32, superName:"Arrow Storm" },

  // ─── GRUDGE 5 MAINS (100x100 originals) ──────────────────────
  { id:"wizard", name:"Wizard", folder:"Wizard", color:"#8e44ad", faction:"crusade", role:"main", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"swordsman", name:"Swordsman", folder:"Swordsman", color:"#e67e22", faction:"crusade", role:"main", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"knight", name:"Knight (Crusade)", folder:"Knight", color:"#e74c3c", faction:"crusade", role:"main", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"orc", name:"Orc", folder:"Orc", color:"#2ecc71", faction:"legion", role:"main", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"werebear", name:"Werebear", folder:"werebear", color:"#6e2c00", faction:"fabled", role:"main", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  // ══════════════════════════════════════════════════════════════
  // ASSIST CHARACTERS (all remaining — MvC-style call-ins)
  // ══════════════════════════════════════════════════════════════

  // ─── Assists: Ranged (Beta) ────────────────────────────────────
  { id:"archer", name:"Archer", folder:"Archer", color:"#27ae60", faction:"crusade", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"priest", name:"Priest", folder:"Priest", color:"#f1c40f", faction:"crusade", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    ...
    assist:{ assistType:"beta", assistAnimation:"attack", cooldown:5, damage:10 },
    atk:9, spd:5.2, superDmg:36, superName:"Holy Smite" },
  { id:"skeleton", name:"Armored Skeleton", folder:"Armored-Skeleton", color:"#95a5a6", faction:"legion", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    ...
    assist:{ assistType:"alpha", assistAnimation:"attack", cooldown:5, damage:13 },
    atk:11, spd:5.8, superDmg:32, superName:"Soul Harvest" },

  // ─── Assists: Melee (Alpha) ───────────────────────────────────
  { id:"armored-orc", name:"Armored Orc", folder:"armored-orc", color:"#196f3d", faction:"legion", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
    attack:["attack1.png",7], attack2:["attack2.png",8], special:["attack3.png",9],
    hurt:["hurt.png",4], death:["death.png",4], block:["block.png",4],
    assist:{ assistType:"alpha", assistAnimation:"attack", cooldown:5, damage:16 },
    atk:14, spd:5.0, superDmg:38, superName:"Iron Tusk" },
  { id:"elite-orc", name:"Elite Orc", folder:"elite-orc", color:"#1e8449", faction:"legion", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
  ...
  { id:"knight-templar", name:"Knight Templar", folder:"knight-templar", color:"#f39c12", faction:"crusade", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
    idle:["idle.png",6], walk:["walk.png",8],
    ...
    assist:{ assistType:"gamma", assistAnimation:"special", cooldown:6, damage:18 },
    atk:14, spd:5.4, superDmg:37, superName:"Holy Crusade" },
  { id:"barbarian-ranger", name:"Barbarian Ranger", folder:"barbarian-ranger", color:"#c0392b", faction:"crusade", role:"assist", frameSize:100, renderScale:2,
    idle:["idle.png",6], walk:["walk.png",6], attack:["attack1.png",6],
    hurt:["hurt.png",4], death:["death.png",4], attack2:["attack2.png",9],
    projectile:"axe.png",
    assist:{ assistType:"beta", assistAnimation:"attack2", cooldown:5, damage:14 },
    atk:12, spd:5.6, superDmg:34, superName:"Axe Storm" },
  { id:"elf-ranger", name:"Elf Ranger", folder:"elf-ranger", color:"#27ae60", faction:"fabled", role:"assist", frameSize:100, renderScale:2,
  ...
  { id:"werewolf", name:"Werewolf", folder:"werewolf", color:"#4a235a", faction:"fabled", role:"assist", frameSize:100, renderScale:2, renderScaleX:1.6, renderScaleY:2.45,
  ...
  { id:"barbarian-warrior", name:"Barbarian", folder:"barbarian-warrior", color:"#d35400", faction:"crusade", role:"assist", frameSize:100, renderScale:2,
    idle:["idle.png",16], walk:["walk.png",8], attack:["attack1.png",30],
    hurt:["hurt.png",8], death:["death.png",40], attack2:["attack2.png",30],
    assist:{ assistType:"alpha", assistAnimation:"attack", cooldown:6, damage:20 },
    atk:16, spd:4.8, superDmg:42, superName:"Berserker Fury" },

  // ─── Assists: 96px heroes ─────────────────────────────────────
  { id:"dark-knight", name:"Dark Knight", folder:"dark-knight", color:"#2c3e50", faction:"legion", role:"assist", frameSize:96,
  ...
  { id:"silver-knight", name:"Silver Knight", folder:"silver-knight", color:"#c0c0c0", faction:"crusade", role:"assist", frameSize:180,
    idle:["Idle.png",11], walk:["Run.png",8], attack:["Attack1.png",7],
    hurt:["Take Hit.png",4], death:["Death.png",11], jump:["Jump.png",3],
  ...
  { id:"crossbowman", name:"Crossbowman", folder:"crossbowman", color:"#566573", faction:"crusade", role:"assist", frameSize:96,
    ...
    assist:{ assistType:"beta", assistAnimation:"special", cooldown:5, damage:14 },
  ...
  { id:"fire-wizard", name:"Fire Wizard", folder:"fire-wizard", color:"#e74c3c", faction:"fabled", role:"assist", frameSize:128,
  ...
  { id:"lightning-mage", name:"Lightning Mage", folder:"lightning-mage", color:"#3498db", faction:"fabled", role:"assist", frameSize:128,
  ...
  { id:"necromancer", name:"Necromancer", folder:"necromancer", color:"#6c3483", faction:"legion", role:"assist", frameSize:128,
    ...
    assist:{ assistType:"beta", assistAnimation:"cast", cooldown:6, damage:14 },
    atk:11, spd:5.0, superDmg:38, superName:"Death Pact" },
  { id:"human-ranger", name:"Human Ranger", folder:"human-ranger", color:"#2e86c1", faction:"crusade", role:"assist", frameSize:128,
  ...
  { id:"human-mage", name:"Human Mage", folder:"human-mage", color:"#5b2c6f", faction:"crusade", role:"assist", frameSize:128,
  ...
  { id:"water-priestess", name:"Water Priestess", folder:"water-priestess", color:"#2980b9", faction:"crusade", role:"assist", frameSize:128,
    idle:["idle.png",8], walk:["walk.png",10], attack:["attack1.png",7],
    hurt:["hurt.png",7], death:["death.png",16], block:["block.png",12],
  ...
  // ─── Assists: 80px/small heroes ───────────────────────────────
  { id:"free-knight", name:"Dwarf Mage", folder:"free-knight", color:"#7d3c98", faction:"fabled", role:"assist", frameSize:96,
    ...
    projectile:"fireball.png",
    assist:{ assistType:"beta", assistAnimation:"cast", cooldown:5, damage:13 },
    atk:11, spd:5.4, superDmg:40, superName:"Arcane Vortex" },
  { id:"nightborne", name:"Nightborne", folder:"nightborne", color:"#2c3e50", faction:"legion", role:"assist", frameSize:80,
    ...
    assist:{ assistType:"gamma", assistAnimation:"cast", cooldown:5, damage:14 },
    atk:12, spd:5.8, superDmg:36, superName:"Void Collapse" },
  { id:"dwarf-ranger", name:"Dwarf Ranger", folder:"dwarf-ranger", color:"#a0522d", faction:"fabled", role:"assist", frameSize:80,
    ...
    projectile:"axe.png",
    assist:{ assistType:"beta", assistAnimation:"attack", cooldown:5, damage:14 },
    atk:12, spd:5.2, superDmg:33, superName:"Dwarven Fury" },

  // ─── Assists: 64px + Unique ───────────────────────────────────
  { id:"arcane-archer", name:"Arcane Archer", folder:"arcane-archer", color:"#1abc9c", faction:"fabled", role:"assist", frameSize:64,
  ...
  { id:"shardsoul-slayer", name:"Shardsoul Slayer", folder:"shardsoul-slayer", color:"#c0392b", faction:"legion", role:"assist", frameSize:64,
    idle:["idle.png",6], walk:["walk.png",6], attack:["attack1.png",6],
  ...
  { id:"evil-wizard", name:"Evil Wizard", folder:"evil-wizard", color:"#4a235a", faction:"legion", role:"assist", frameSize:150,
    idle:["idle.png",8], walk:["walk.png",8], attack:["attack1.png",8],
    hurt:["hurt.png",4], death:["death.png",5], attack2:["attack2.png",8],
    projectile:"fireball.png",
    assist:{ assistType:"beta", assistAnimation:"attack", cooldown:6, damage:14 },
    atk:12, spd:5.0, superDmg:42, superName:"Dark Cataclysm" },
  { id:"martial-hero", name:"Martial Hero", folder:"martial-hero", color:"#d4ac0d", faction:"crusade", role:"assist", frameSize:200,
    ...
    assist:{ assistType:"alpha", assistAnimation:"attack", cooldown:5, damage:15 },
    atk:13, spd:6.6, superDmg:34, superName:"Dragon Fist" },
  { id:"wanderer-magician", name:"Wanderer Magician", folder:"wanderer-magician", color:"#8B4513", faction:"fabled", role:"assist", frameSize:128,
    ...
    projectile:"fireball.png",
    assist:{ assistType:"gamma", assistAnimation:"special", cooldown:5, damage:14 },
    atk:11, spd:5.6, superDmg:40, superName:"Eldritch Storm" },
  { id:"loreon-knight", name:"Loreon Knight", folder:"loreon-knight", color:"#f4d03f", faction:"crusade", role:"assist", frameSize:48,
